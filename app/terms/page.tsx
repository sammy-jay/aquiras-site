        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 text-lg md:text-xl max-w-3xl mx-auto">
              Welcome to Aquiras! These terms and conditions outline the rules
          ...
          <div className="max-w-4xl mx-auto space-y-12">
            <section>
              ...
              <p className="text-gray-400 text-lg leading-relaxed">
                Aquiras our is an innovative agency amplified with AI, offering a range of creative and digital services.
            ...
            <section>
              ...
              <p className="text-gray-400 text-lg leading-relaxed">
                ...
                of Aquiras and is protected by intellectual property laws. Users may not use, reproduce, or distribute
            ...
            <section>
              ...
              <p className="text-gray-400 text-lg leading-relaxed">
                Aquiras is not liable for any indirect, incidental, special, consequential, or punitive damages
            ...
            <section>
              ...
              <p className="text-gray-400 text-lg leading-relaxed">
                For questions about these terms, please contact us at support@Aquiras.com or through our contact form.
              </p>
            </section>
          </div>
        </div>
