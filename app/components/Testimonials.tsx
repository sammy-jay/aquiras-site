...
const testimonial1 = {
  ...
  quote: "Aquiras Solutions revolutionized our lead generation process. We're now swimming in qualified prospects, and our sales team is closing deals faster than ever!",
  author: {
    name: 'Jane Doe',
    role: 'VP of Sales',
...
const testimonial2 = {
  ...
  quote: "Our customer support is now a revenue-generating asset thanks to Aquiras Solutions. Their AI solutions provide instant, personalized assistance, leading to happier customers and increased loyalty.",
  author: {
    name: 'John Smith',
...
const clientTestimonials = [
  ...
  },
  {
    ...
    quote: "Aquiras Solutions's workflow automation has freed up our team to focus on strategic initiatives, boosting productivity and profitability.",
    author: {
      name: 'Michael Chen',
  ...
  {
    logo: 'Chevron',
    quote: "Thanks to Aquiras Solutions, our marketing campaigns are now laser-focused and deliver incredible results. We've seen a huge boost in ROI.",
    author: {
      name: 'David Williams',
      role: 'Marketing Lead'
    }
