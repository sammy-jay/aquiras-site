...
const faqs = [
  {
    ...
    answer: "At Aquiras Solutions, we offer a comprehensive range of IT services including enterprise software solutions, OEM software licensing, hardware procurement, network infrastructure, IT security audits, web development, and ongoing technical support."
  },
  {
          ...
          {faqs.map((faq, index) => (
            ...
            >
              <button
                ...
                className={`w-full text-left p-6 rounded-[24px] transition-colors ${
                  openIndex === index ? 'bg-[#111]' : 'bg-[#111] hover:bg-[#161616]'
                }`}
              >
