        ...
        <div className="max-w-3xl mx-auto">
          <form onSubmit={handleSubmit} className="space-y-8">
            <div className="bg-[#0A0A0A] rounded-[32px] p-8 space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                >
                  ...
                  <input
                    ...
                    required
                    className="w-full bg-[#111] border border-gray-800 rounded-2xl px-6 py-4 text-lg focus:outline-none focus:border-[#60a5fa] transition-colors"
                    value={formData.name}
              ...
              >
                <label className="block text-xl mb-3">
                  Company Name <span className="text-[#60a5fa]">*</span>
                </label>
                <input
                  type="text"
              ...
              <motion.div
                ...
                >
                  <label className="block text-xl mb-3">
                    Select Service <span className="text-[#60a5fa]">*</span>
                  </label>
                  <select
                    required
              ...
              >
                ...
                <textarea
                  ...
                  rows={6}
                  className="w-full bg-[#111] border border-gray-800 rounded-2xl px-6 py-4 text-lg focus:outline-none focus:border-[#60a5fa] transition-colors resize-none"
              ...
              <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="w-full md:w-auto bg-[#60a5fa] text-white px-8 py-4 rounded-2xl text-lg font-medium hover:bg-[#60a5fa]/90 transition-colors"
                >
                  Submit
                </motion.button>
